        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="container shadow-lg p-3 mb-5 bg-body rounded my-3 ">
                    ...
                    ?>
                    <img src="asset/logo.png" class="logo img-fluid" alt="logo" style="height: 230px; width: 500px">
                    ...
                    <p class="text-light text-center my-3"><a href="#" class="text-decoration-none ">forgot
                            password?</a></p>
                    <p class="text-dark text-center my-3">Do you have account? <a href="signup.php">Sign Up</a></p>
                </div>
            </div>
            <div class="col-sm-4">
